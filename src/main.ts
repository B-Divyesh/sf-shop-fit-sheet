...
function notFound(): string {
  ...
  return `${header()}<main id="main" class="not-found" tabindex="-1"><div class="pressed-leaf">${icon('leaf')}</div><div><h1 tabindex="-1">This page is not on the sheet</h1><p>The address may be wrong or the page may have moved.</p><a class="primary-button" href="/" data-link>Return to the fit checker</a></div></main>${footer()}`;
}
