...
- First screen: demo mode skips the landing artwork and opens on the loaded project name, live verdict, and exact conflict.
...
- Reset: use **Reset demo** in the sticky banner. The button remains available while the form and results are in view.
