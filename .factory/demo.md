...
- Navigation: the wordmark and **Planner** keep the sample project in demo mode. Legal pages carry demo mode in the URL and keep the banner. Only **Start for real** opens real storage.
